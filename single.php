...
<section class="container">
	...
	<div class="content">
		...
		<article class="article-content">
			<?php _the_ads($name='ads_post_01', $class='orbui-post orbui-post-01') ?>
			<?php the_content(); ?>
		</article>
		<?php wp_link_pages('link_before=<span>&link_after=</span>&before=<div class="article-paging">&after=</div>&next_or_number=number'); ?>
		<?php if (_hui('ads_post_footer_s')) {
			echo '<div class="orbui-post-footer"><b>AD：</b><strong>【' . _hui('ads_post_footer_pretitle') . '】</strong><a'.(_hui('ads_post_footer_link_blank')?' target="_blank"':'').' href="' . _hui('ads_post_footer_link') . '">' . _hui('ads_post_footer_title') . '</a></div>';
		} ?>
		<?php 
		...
		<?php _the_ads($name='ads_post_02', $class='orbui-post orbui-post-02') ?>
		<?php 
		...
		?>
		<?php _the_ads($name='ads_post_03', $class='orbui-post orbui-post-03') ?>
